...
data_dir = r"D:\Projects\MSCelebB"                                                                       # directory containing the training set
...
learning_rate = '-1'                                                                                     # learning rate used in traning, if set to -1 it will use the values in scheduler
batch_size = '30'                                                                                        # number of images in each batch
max_nrof_epochs = '300'                                                                                   # number of epochs to run 
...
val_split = '0'                                                                                        # part of the training set used for validation
val_epcohs = '1000'                                                                                       # number of epochs at which validation is done
#epoch_size = '278544'                                                                                    # number of batches per epoch   
epoch_size = '10000'   
